...
\section{Creating a Slide Deck}

\begin{frame}{Slide Deck}
    \begin{itemize}
...
\begin{frame}{Creating a Julius Workflow}
 
    Let's try building in pieces, getting each piece to work before moving on.
    \begin{enumerate} 
        \item Balance sheet Net PP\&E
        \item Income statement 
        \item Balance sheet Net Working Capital
        \item Statement of cash flows
        \item Valuation 
    \end{enumerate}
\end{frame}

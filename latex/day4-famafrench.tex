...
\item \pause Fama-French (1993) said we don't know, but we do know that small stocks beat big stocks on average and high book-to-market (value) stocks beat low book-to-market (growth) stocks on average.
...
\begin{frame}{Implementing the Fama-French 5-factor model}
    \begin{itemize}

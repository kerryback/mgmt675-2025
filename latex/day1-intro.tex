...
\begin{frame}{Warm-Up}
  Click "+ New" to start a chat with Julius.  Ask it to do the following (you could start a new chat for each topic):
\begin{itemize}
...
\begin{frame}{Example Workflow}
  ...
  \item Julius prompt: Use yfinance to get the closing price of the stock from Yahoo Finance beginning at the start date.  Output the result to a jpeg file and show it to the user.
  \end{itemize}
\end{frame}

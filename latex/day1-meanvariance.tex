...
\item Given tangency portfolio,
  \begin{itemize}
  \item use same formula as in Applied Finance to find minimum risk portfolio achieving target expected return
  \item analogous formula to find maximum expected return portfolio satisfying a risk limit
  \end{itemize}
\end{itemize}
\end{frame}
...
\begin{frame}{Excel Spreadsheet Examples}

Based on Topic5.1\_SharpeRatioExamples\_Revised.xlsx

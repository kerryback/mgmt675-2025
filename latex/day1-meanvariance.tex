...
\begin{itemize}
  ...
  \item Correlations and standard deviations
  \item Risk-free rate
  \item Portfolio objective (risk limit or target expected return)
  \end{itemize}
  \item Julius prompt
  \begin{itemize}
  \item Compute and output desired portfolio
  \item Plot the hyperbola and the capital allocation line
  \item Show the desired portfolio on the plot
  \end{itemize}
\end{frame}
\end{document}

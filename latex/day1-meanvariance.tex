...
\end{itemize}
  ...
  \begin{frame}{Checking Julius' Work}
    Run the workflow with data from Topic5.1\_SharpeRatioExamples.xlsx from Applied Finance (linked on our Schedule page for Day 1).
    
    Check that the tangency portfolio is correct.
  \end{frame}
\end{document}

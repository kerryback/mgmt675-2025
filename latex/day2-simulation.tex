...
\begin{frame}{Retirement planning workflow}
\begin{itemize}
\item User prompt: specify in real terms (today's dollars)
\begin{itemize}
...
\item Julius prompt:
\begin{itemize}
\item simulate the investment account balance year by year and repeat 1,000 times
